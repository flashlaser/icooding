...
<title>${forum==null?"我的主题":forum.forumName}--${forum.title==null||forum.title==""?setting.siteName:forum.title}</title>
<meta charset="utf-8">
...
<body>
		...
		<div class="btn-group newTheme">
			<button type="button" class="btn btn-primary dropdown-toggle"
				data-toggle="dropdown" aria-expanded="false">
				发布主题 <span class="caret"></span>
			</button>
			<ul class="dropdown-menu" role="menu">
				<li><a href="theme/addTheme?fid=${forum.fid}">发布主题</a></li>
				<!-- <li><a href="#">Another action</a></li>
				<li><a href="#">Something else here</a></li>
				<li class="divider"></li>
				<li><a href="#">Separated link</a></li> -->
			</ul>
			<a class="btn btn-link pull-right" href='myTheme-${userSession.user.uid}-1.html' >我的主题</a>
		</div>
		</c:if>
		<div class="main row">
		<div class=" col-md-8">
