...
<div class="container">
	<div class="logo hidden-xs hidden-sm">
		<div class="left pull-left">
			<div class="header-logo pull-left"><a href="/"><img src="static/images/logo-white.png" width=100 alt="${setting.appName}"></a></div>
...
<nav class="navbar navbar-default ">
	<div class="container">
		...
		<div class="navbar-header visible-xs-block  visible-sm-block">
			...
			<a class="navbar-brand" href="http://${setting.appUrl}/"><img src="static/images/logo.png"
