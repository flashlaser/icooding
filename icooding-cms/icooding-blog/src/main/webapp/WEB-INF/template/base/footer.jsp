            ...
            <div class="modal-body">
                <form class="form-horizontal" id="linkForm" autocomplete="off">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="linkName" name="linkName" datatype="*"
                                   placeholder="要显示的友链名称,不超过10个字" maxlength="10">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="linkUrl" class="col-sm-2 control-label">友链地址</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="linkUrl" name="linkUrl" datatype="url"
                                   placeholder="友链地址">
                        </div>
                    </div>
                    <div class="form-group">
...
<c:if test="${setting.changyanAppId!=null}">
    <!-- 多说公共JS代码 start (一个网页只需插入一次) -->
    <script type="text/javascript" charset="utf-8" src="https://changyan.itc.cn/js/lib/jquery.js"></script>
    <script type="text/javascript" charset="utf-8" src="https://changyan.sohu.com/js/changyan.labs.https.js?appid=${setting.changyanAppId}"></script>
    <script type="text/javascript">
        (function () {
            var appid = '${setting.changyanAppId}';
            var conf = '${setting.changyanSecret}';
