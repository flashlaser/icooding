				...
				<form id="infoForm" onsubmit="return false;">
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group">
								<label>文章打赏</label> <br>
								<input type="radio" id="grant1" name="grant" ${!setting.grant?"checked":""} value="false" /><label for="grant1">关闭</label>
								<input type="radio" id="grant2" name="grant" ${setting.grant?"checked":""} value="true" /><label for="grant2">开启</label>
							</div>
						</div>
						<div class="col-lg-6">
							<label class="help-block">文章打赏</label>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-6">
