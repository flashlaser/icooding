...
<body>
	...
	<link href="static/js/jquery-ui-1.11.1/jquery-ui.css" rel="stylesheet" type="text/css" />
	...
	<div class="main row">
		...
		<div class="right col-md-10">
			<div class="site">
				<div class="site_left">
					<h5>
						<a href="javascript:;" rel="nofollow">后台</a> ><a href="filelist/index">文件管理</a> > 任务管理
					</h5>
				</div>
			</div>
...
<script type="text/javascript" src="static/js/base/navi.js"></script>
<script type="text/javascript" src="static/js/cloud/uploadList.js"></script>
<script type="text/javascript" src="static/js/ZeroClipboard/ZeroClipboard.js"></script>
<script type="text/javascript" src="static/js/cloud/upload.js"></script>
</body>
</html>
