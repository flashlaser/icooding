...
<body>
	...
	<script src="static/js/theme/comment.min.js"></script>
	<script type="text/javascript" src="static/js/ckplayer/ckplayer.js" charset="utf-8"></script>
	<script type="text/javascript" src="static/js/offlights.js" charset="utf-8"></script>
