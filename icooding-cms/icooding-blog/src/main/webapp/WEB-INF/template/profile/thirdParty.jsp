...
<body>
				...
				<div class=" col-md-10 col-xs-12">
					...
					<div class="thirdParty row">
						...
						<div class="col-xs-8">
							...
							<img src="${qq==null?" static/images/default_headicon.png":qq.headIconBig}" class="img-thumbnail"
								width=100 />
						</div>
						<div class="col-xs-4">
						...
						<div class="col-xs-8">
							...
							<img src="${weibo==null?" static/images/default_headicon.png":weibo.headIconBig}" class="img-thumbnail"
								width=100 />
						</div>
					</div>
				</div>
	...
	<script type="text/javascript" src="static/js/Validform/Validform_v5.3.2.js"></script>
